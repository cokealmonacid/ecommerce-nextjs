const LoadingSpinner = () => (
  <div className="bg-white w-full min-h-[800px] flex justify-center items-center">
    <div className="bg-white p-10 rounded-xl relative">
      <svg className="w-20 h-20 animate-spin text-slate-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
